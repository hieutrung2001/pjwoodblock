...
<head>
    ...
    <title>Quản lý hiển thị trang chủ</title>
                ...
                <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
                    ...
                    <div class="flex justify-center flex-1 lg:mr-32">
                        <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                            ...
                            <form action="{{ route('admin.home.display.index') }}" method="get">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                <div class="btn-checkbox">
                                                    @if ($w['is_displayed'] == 1)
                                                    <input type="checkbox" name="selected-woodblock" id="{{ $w['code'] }}" checked>
                                                    @else
                                                    <input type="checkbox" name="selected-woodblock" id="{{ $w['code'] }}">
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
...
<script>
    let totalWoodblocks = document.getElementById('total-woodblocks');
    let btnCheckBoxInputs = document.querySelectorAll('.btn-checkbox > input');
    // console.log(btnCheckBoxInputs);
    for (let i = 0; i < btnCheckBoxInputs.length; ++i) {
        $.ajaxSetup({
            headers: {
        ...
        btnCheckBoxInputs[i].addEventListener('click', (e) => {
            let checkedBox = countCheckedBox(btnCheckBoxInputs);
            console.log(checkedBox);
            if (e.target.checked) {
                // checkedBox += 1;
                if (checkedBox > 6) {
                    alert('Số lượng không được vượt quá 6!');
