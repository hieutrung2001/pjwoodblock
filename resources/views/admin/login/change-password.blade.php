				...
				<div class="container px-6 mx-auto grid">
					...
					<form action="{{ route('admin.user.change-password') }}" method="post">
						...
						<label class="block text-sm">
							...
							<input name="old-password" id="old-password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" required />
						</label>
						<label class="block text-sm mt-1">
							<span class="text-gray-700 dark:text-gray-400">Mật khẩu mới</span>
							<input type="password" name="new-password" id="new-password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" required />
						</label>
						<label class="block text-sm mt-1	">
							<span class="text-gray-700 dark:text-gray-400">Nhập lại mật khẩu</span>
							<input type="password" name="repeat-new-password" id="repeat-new-password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" required />
						</label>
						<!-- <input type="submit" value="Thêm" /> -->
						<button type="submit" id="btn-change-password" style="white-space: nowrap;" class="mt-4 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple !whitespace-nowrap">Thay đổi</button>
					</form>
				</div>
			</main>
		</div>
