						...
						<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
							<label class="block mt-4 text-sm mt-8">
								...
								<label class="block text-sm mt-1">
									...
									<input value="{{ $books->name }}" name="books" class="block w-full text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="" />
								</label>
							</label>
							<label class="block mt-8 text-sm">
								<span class="text-gray-700 dark:text-gray-400">Thông tin về bộ sách</span>
								<textarea name="books-detail" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" rows="5" placeholder="">{{ $books->description }}</textarea>
							</label>
							<label class="block mt-5 text-sm">
								<span class="text-gray-700 dark:text-gray-400">Ngày tạo</span>
								<p>{{ gmdate("Y-m-d", $books->created ) }}</p>
							</label>
							<label class="block mt-5 text-sm">
								<span class="text-gray-700 dark:text-gray-400">Ngày thay đổi</span>
								@if (!empty($books->modified))
								<p>{{ gmdate("Y-m-d", $books->modified ) }}</p>
								@else 
								<p>Chưa thay đổi</p>
								@endif
							</label>
							<button type="submit" style="white-space: nowrap;" class="px-4 py-2 mt-5 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple !whitespace-nowrap">Chỉnh sửa</button>
						</div>
					</form>
				</div>
			</main>
